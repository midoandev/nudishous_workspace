...
7. Menambahkan Skrip generate ke Melos
   Buka file melos.yaml Anda, dan tambahkan skrip generate di bawah blok scripts: yang sudah ada
   sebelumnya:
   scripts:
...
8. Mengisi "Nyawa" ke core_logic
   ...
   Perintah di atas menyuruh Melos: "Tolong jalankan flutter pub add... tapi hanya di dalam paket
   core_logic."
...
11. Langkah 2: Membuat "Nutrient Sanitizer" di openfood_api
    ...
    double get safeCalories => nutriments?.getValue(Nutrient.energyKcal, PerSize.oneHundredGrams) ??
    0.0;
    double get safeProtein => nutriments?.getValue(Nutrient.proteins, PerSize.oneHundredGrams) ??
    0.0;
    double get safeCarbs => nutriments?.getValue(Nutrient.carbohydrates, PerSize.oneHundredGrams) ??
    0.0;
...
15. Enable Dart Support: * Centang "Enable Dart support for the project 'nudishous_workspace'".
    ...
    Pada Dart SDK path, arahkan ke folder SDK Flutter Anda. Contoh:
    /Users/nama_user/flutter/bin/cache/dart-sdk.
